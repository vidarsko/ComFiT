...
In all of these applications, the role of topological defects is central to understanding the critical dynamics and the statistical properties of the systems. For example, in Bose-Einstein condensates the formation of vortices mark the transition to quantum turbulence and in crystals, and the formation of dislocations are central to understanding how materials buckle.
...
The Phase Field Crystal framework is currently under exploration at the Njord Centre at the University of Oslo for modeling crack propagation in Earth's upper crust and the basic framework is used as a foundation for several projects in the theoretical physics group at Porelab, UiO.
