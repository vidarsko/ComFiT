...
<a href="https://colab.research.google.com/github/vidarsko/ComFiT/blob/main/tutorial/file_name.ipynb" class="card">
    ...
    <hr>
    <p>
    <img src="_link_to_light_theme_image_#only-light" alt="Placeholder tutorial card image">
    <img src="_link_to_dark_theme_image_#only-dark" alt="Placeholder tutorial card image">
    </p>
